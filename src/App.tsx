  ...
  return (
    <div className="flex flex-col min-h-screen items-center">
      ...
      <section className="container mx-auto px-4 py-20 flex flex-col lg:flex-row items-center gap-12 text-white">
        <div className="lg:w-1/2 space-y-6">
          ...
          <p className="text-lg text-gray-300 max-w-xl">
            Discover, track, and review your favorite movies and books all in one place. Build your watchlist and
            reading list with Listory.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              Listory combines the best features for movie and book enthusiasts in a single platform.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-900 p-6 rounded-xl hover:bg-gray-800 transition-colors">
              ...
              <p className="text-gray-300">Find new movies and books based on your preferences and what's trending.</p>
            </div>
            ...
            <div className="bg-gray-900 p-6 rounded-xl hover:bg-gray-800 transition-colors">
              ...
              <p className="text-gray-300">
                Create watchlists and reading lists to keep track of what you want to experience next.
              </p>
            </div>
            ...
            <div className="bg-gray-900 p-6 rounded-xl hover:bg-gray-800 transition-colors">
              ...
              <p className="text-gray-300">Share your thoughts and see what others think about your favorite titles.</p>
            </div>
            ...
            <div className="bg-gray-900 p-6 rounded-xl hover:bg-gray-800 transition-colors">
              ...
              <p className="text-gray-300">
                Access comprehensive information about thousands of films from all eras and genres.
              </p>
            </div>
            ...
            <div className="bg-gray-900 p-6 rounded-xl hover:bg-gray-800 transition-colors">
              ...
              <p className="text-gray-300">Explore our extensive collection of books across all literary categories.</p>
            </div>
            ...
            <div className="bg-gray-900 p-6 rounded-xl hover:bg-gray-800 transition-colors">
              ...
              <p className="text-gray-300">
                We have a vibrant community of users who share their recommendations and reviews.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="how-it-works" className="py-20 text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">How Listory Works</h2>
            <p className="text-gray-300 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-300">Sign up for free and set up your profile with your preferences.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Browse our vast library of movies and books or search for specific titles.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">Save to your lists, rate what you've watched or read, and share reviews.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="testimonials" className="py-20 text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              Join thousands of satisfied users who have transformed how they track their entertainment.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-900 p-6 rounded-xl">
              ...
              <p className="text-gray-300 mb-4">
                "Listory has completely changed how I keep track of movies I want to watch. The interface is intuitive
                and the recommendations are spot on!"
              </p>
            ...
            <div className="bg-gray-900 p-6 rounded-xl">
              ...
              <p className="text-gray-300 mb-4">
                "As an avid reader, I've tried many book tracking apps, but Listory stands out with its clean design and
                comprehensive database. Love it!"
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-purple-600 rounded-full"></div>
                <div>
            ...
            <div className="bg-gray-900 p-6 rounded-xl">
              ...
              <p className="text-gray-300 mb-4">
                "The community aspect of Listory is what makes it special. I've discovered so many hidden gems through
      ...
      <section className="py-20 text-white">
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-r from-purple-900 to-purple-700 rounded-2xl p-8 md:p-12 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Start Your Listory?</h2>
            <p className="text-lg text-white/90 max-w-2xl mx-auto mb-8">
              Join thousands of users who are tracking, discovering, and sharing their favorite movies and books.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button className="bg-white text-purple-900 hover:bg-purple-900 px-8 py-6 hover:text-white transition-all ease-in-out duration-300" onClick={() => navigate("/login")}>Sign Up for Free</Button>
            </div>
          </div>
        </div>
      </section>
